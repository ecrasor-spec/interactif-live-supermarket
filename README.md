...
Le plugin `0.1.13` est fonctionnel avec Supermarket Simulator 1.0.43.0 et expose un pont local utilisé par Interactif Live. Les actions disponibles sont séparées de Minecraft : clients, voleurs, livraisons aléatoires, déchets, saleté, nettoyage, progression et éclairage.
